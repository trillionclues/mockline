export function subscriptionCancelledTemplate(userName?: string | null): string {
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <td style="background:#ffffff;border:1px solid #1a1a2e;border-radius:8px;padding:32px 28px;">
            ...
            <p style="margin:0 0 24px;font-size:13px;color:#0a0a0b;line-height:1.7;">
              Your Mockline subscription has been scheduled to cancel at the end of your current billing period. 
              You'll keep your premium features until then.
            </p>
            ...
            <p style="margin:0 0 24px;font-size:13px;color:#0a0a0b;line-height:1.7;">
              We'll miss you! If there's anything we could have done better, 
