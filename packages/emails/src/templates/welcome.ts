...
<head>
  ...
  <title>Welcome to Mockline 🚀</title>
</head>
        ...
        <tr>
          <td style="background:#ffffff;border:1px solid #1a1a2e;border-radius:8px;padding:32px 28px;">
            ...
            <p style="margin:0 0 24px;font-size:13px;color:#0a0a0b;line-height:1.7;">
              I'm Excel, the creator of Mockline. I'm happy to have you onboard!
            </p>
            <p style="margin:0 0 24px;font-size:13px;color:#0a0a0b;line-height:1.7;">
            ...
            <p style="margin:0 0 24px;font-size:13px;color:#0a0a0b;line-height:1.7;">
            To get started, head over to your dashboard and upload your first spec. In just seconds, you'll have a live endpoint ready for your engineering team to query against.
            </p>
            ...
            <p style="margin:0;font-size:13px;color:#0a0a0b;line-height:1.6;">
              Cheers,
            </p>
          </td>
        </tr>
