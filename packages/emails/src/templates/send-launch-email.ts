export function launchTemplate(name?: string | null): string {
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <tr>
          <td style="background:#ffffff;border:1px solid #1a1a2e;border-radius:8px;padding:32px 28px;">
            <p style="margin:0 0 20px;font-size:14px;color:#0a0a0b;line-height:1.6;">${greeting}</p>
            <p style="margin:0 0 24px;font-size:13px;color:#0a0a0b;line-height:1.7;">
              Mockline is live. You signed up for early access a while back — today you can use it.
            </p>
            <p style="margin:0 0 24px;font-size:13px;color:#0a0a0b;line-height:1.7;">
              Upload your OpenAPI spec and get an isolated mock API server running in seconds. No backend team needed.
            </p>
            <table cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
              <tr>
                <td style="background:#F2E3BB;border-radius:6px;">
                  <a href="https://mockline.xyz"
            ...
            <p style="margin:0;font-size:13px;color:#0a0a0b;line-height:1.7;">
              Questions? Just reply to this email.<br>— Excel
            </p>
          </td>
        </tr>
        <tr>
          <td align="center" style="padding-top:20px;">
            <p style="margin:0;font-size:11px;color:#3f3f46;line-height:1.8;text-align:center;">
              You signed up at <a href="https://mockline.xyz" style="color:#52525b;text-decoration:none;">mockline.xyz</a>
              <br>© ${new Date().getFullYear()} Mockline. All rights reserved.
            </p>
          </td>
        </tr>
      </table>
