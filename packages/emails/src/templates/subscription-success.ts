export function subscriptionSuccessTemplate(userName?: string | null): string {
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <td style="background:#ffffff;border:1px solid #1a1a2e;border-radius:8px;padding:32px 28px;">
            ...
            <p style="margin:0 0 24px;font-size:13px;color:#0a0a0b;line-height:1.7;">
              Your payment was successful and your Mockline subscription is now active! 
              You can continue building and serving your mock APIs without any interruptions.
            </p>
            <table cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
              <tr>
                <td style="background:#F2E3BB;border-radius:6px;">
                  <a href="${process.env.NEXT_PUBLIC_APP_URL ?? 'https://mockline.xyz'}/overview"
            ...
            <p style="margin:0 0 24px;font-size:13px;color:#0a0a0b;line-height:1.7;">
              If you have any questions or need a receipt, you can manage your billing anytime from your settings.
            </p>
          </td>
        </tr>
        <tr>
