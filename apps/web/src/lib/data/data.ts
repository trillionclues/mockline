...
export const PLANS = [
    ...
    },
    {
        ...
        features: [
            ...
            { text: 'Unlimited specs & Always-on servers', included: true },
            ...
            { text: 'Partner sandboxes (up to 14 days)', included: true },
            { text: 'Sandbox share pages', included: true },
            { text: 'Basic usage analytics (14-day retention)', included: true },
        ],
        cta: 'Upgrade to Pro',
    ...
    },
    {
        ...
        features: [
            ...
            // { text: 'SSO & Team workspaces (coming soon)', included: true },
            { text: 'Custom mock servers & domains', included: true },
            { text: 'Partner sandboxes (up to 90 days)', included: true },
            { text: 'White-label share pages', included: true },
            { text: 'Full analytics + weekly digest (30-day retention)', included: true },
        ],
        cta: 'Contact us',
